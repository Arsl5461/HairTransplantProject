...
function Clinic() {
  return (
    <div className="container mt-4">
        ...
        <div className="col-lg-6 col-md-12 col-sm-6">
            <h1>Why should I choose </h1>
            <h1><b>Hair Rebirth Clinic?</b></h1>
            <p className='w-50'>We recognize that you have a wide variety of providers to choose from. So what sets us apart from others in the field?
</p>

    <li className='list-unstyled' style={{color:"#AC8A50"}}>State of the art operating rooms & equipment</li>
    <li className='list-unstyled' style={{color:"#AC8A50"}}>Resident doctors & specialists</li>
